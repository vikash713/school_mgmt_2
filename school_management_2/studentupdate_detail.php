...
// Fetch the student details based on the provided JSON data
if (isset($_GET['data'])) {
    ...
    $student_courses_query = "SELECT course_id FROM studentcourse WHERE student_id = ?";
    ...
    echo "<p>No student data provided.</p>";
    exit;
}
?>
    ...
    <form action="student_display.php" method="POST">
        ...
        <div class="form">
            <div class="input_feild">
                ...
                <input type="text" id="id" value="<?php echo htmlspecialchars($student_data['id']); ?>" name="id" readonly>
            </div>
            <div class="input_feild">
                <label for="fname">First Name</label>
                <input type="text" id="fname" value="<?php echo htmlspecialchars($student_data['fname']); ?>" name="fname">
            </div>
            <div class="input_feild">
                <label for="lname">Last Name</label>
                <input type="text" id="lname" value="<?php echo htmlspecialchars($student_data['lname']); ?>" name="lname">
            </div>
            <div class="input_feild">
                <label for="password">Password</label>
                <input type="password" id="password" value="<?php echo htmlspecialchars($student_data['password']); ?>" name="password">
            </div>
            <div class="input_feild">
            ...
            <div class="input_feild">
                ...
                <input type="email" id="email" value="<?php echo htmlspecialchars($student_data['email']); ?>" name="email">
            </div>
            <div class="input_feild">
                <label for="phone">Phone Number</label>
                <input type="text" id="phone" value="<?php echo htmlspecialchars($student_data['phone']); ?>" name="phone">
            </div>
            <div class="input_feild">
                <label for="address">Address</label>
                <textarea id="address" name="address"><?php echo htmlspecialchars($student_data['address']); ?></textarea>
            </div>
            <div class="input_feild">
                <label>Course</label>
                <?php
                while ($course = mysqli_fetch_assoc($course_run)) {
                    $checked = in_array($course['course_id'], $student_courses) ? 'checked' : '';
